        ...
        <div className={`card ${styles.bg}`}>
            ...
            <div className="card-body">
                ...
                <div className='d-flex justify-content-around'>
                    <button onClick={handleEdit} className='w-25 border-1 btn-outline-success btn rounded-5 px-2 bi bi-pen' />
...
//میتونم با یه استیت اینپوت هارو صدا کنم و مقدار بگیرم و بعد ادیتو هندل کنم
